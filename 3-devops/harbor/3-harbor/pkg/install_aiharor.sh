...
if [ ! -z "${HARBOR_NETWORK_CIDR}" ]; then
  prepare_para="${prepare_para} ${HARBOR_NETWORK_CIDR}"
fi

h2 "-- [Step $item] prepare comond: ./prepare_aiharor $prepare_para "

./prepare_aiharor $prepare_para
echo ""
